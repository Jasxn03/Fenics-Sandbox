...
if mesh_comm.rank == model_rank:
    ...
    left_line = gmsh.model.occ.addLine(p6, p1)
    right_line = gmsh.model.occ.addLine(p5, p7)
    bottom_line = gmsh.model.occ.addLine(p7,p6)
    biofilm_boundary = gmsh.model.occ.addCurveLoop([biofilm_top, right_line, bottom_line, left_line])
